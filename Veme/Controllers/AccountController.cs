            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    try
                    {
                        ...
                        {
                            City = model.MerchantAddress.City,
                            Country = model.MerchantAddress.Country,
                            Parish = model.MerchantAddress.Parish,
                            StreetAddress1 = model.MerchantAddress.StreetAddress1,
                            StreetAddress2 = model.MerchantAddress.StreetAddress2
                        });
